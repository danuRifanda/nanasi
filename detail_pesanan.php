    ...
    <div class="container">
      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
          ...
          <?php $totalbelanja = 0; ?>
          <?php 
              $pemesanan = $koneksi->query("SELECT * FROM pemesanan WHERE id_pemesanan='$_GET[id]'");
      ...
      $id= $_GET['id'];
        if(isset($_POST["bayar"]))
        {
          ...
          $edit = mysqli_query($koneksi, "UPDATE pemesanan SET isApproved=1 WHERE id_pemesanan='$id' ");
