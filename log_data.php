  ...
  <body>
    ...
    <div class="container">
      <div class="judul-pesanan mt-5">
        ...
        <h3 class="text-center font-weight-bold">DATA PENJUALAN</h3>
      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
          ...
          $ambil = mysqli_query($koneksi, "SELECT * from pemesanan_produk JOIN produk ON pemesanan_produk.id_menu = produk.id_menu JOIN pemesanan ON pemesanan.id_pemesanan = pemesanan_produk.id_pemesanan WHERE isApproved=1");
          ...
          <?php foreach ($result as $result) : ?>
            ...
            <tr>
              ...
              <td><a href="clear_penjualan.php?id=<?php echo $result['id_pemesanan'] ?>" class="badge badge-danger">Hapus Data</a></td>
            </tr>
            <?php $nomor++; ?>
          <?php endforeach; ?>
        </tbody>
