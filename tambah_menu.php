...
<html lang="en">
 ...
 <!-- Form Registrasi -->
  <div class="container">
    ...
    <div class="card p-5 mb-5">
      <form method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <label for="menu1">Detail Menu</label>
          <input type="text" class="form-control" id="detail1" name="detail_menu" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="stok1" name="stok" required>
        </div>
        <div class="form-group">
  ...
  if(isset($_POST['tambah'])){
    ...
    $insert = mysqli_query($koneksi, "INSERT INTO produk VALUES (NULL, '$nama', '$jenis', '$stok', '$harga', '$nama_file', '$detail')");
