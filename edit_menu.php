    ...
    <div class="card p-5 mb-5">
      <form method="POST" action="edit.php" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="detail1" name="detail_menu" value="<?php echo $result[0]['detail_menu'] ?>">
        </div>
        <div class="form-group">
          <label for="#">Jenis Menu</label>
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" name="jenis_menu" value="Makanan" checked>Makanan 
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
        ...
        <label for="gambar">Foto Menu Sebelumnya</label>
        <div class="form-group">
          <img src="upload/<?php echo $result[0]['gambar'] ?>" class="card-img-top w-50 " alt="...">
        </div>
        <div class="form-group">
          <label for="gambar">Foto Menu Baru</label>
