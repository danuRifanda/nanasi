  ...
  <!-- Menu -->
    <div class="container">
      <div class="judul-pesanan mt-5">
        ...
        <h3 class="text-center font-weight-bold">DATA MENU</h3>
      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
          <?php $nomor=1; ?>
          <?php 
            $ambil = mysqli_query($koneksi, 'SELECT * FROM produk order by nama_menu asc');
          ...
          <tr>
            ...
            <td><a href="detail_menu.php?kd=<?php echo $result['id_menu'];?>"><span></span> <?php echo $result['nama_menu'];?></td>
            <td><?php echo $result["stok"]; ?></td>
            <td>Rp. <?php echo number_format($result["harga"]); ?></td>
            <td>
              
              <a href="edit_menu.php?id_menu=<?php echo $result['id_menu']  ?>" class="badge badge-primary">Update</a>
             

              <a href="hapus_menu.php?id_menu=<?php echo $result['id_menu']  ?>" class="badge badge-danger">Delete</a>
            </td>
          </tr>
          <?php $nomor++; ?>
          <?php endforeach; ?>
  ...
  <!-- Awal Footer -->
      ...
      <div class="container">
        <div class="row footer-body">
          <div class="col-md-6">
          <div class="copyright">
            <strong>Copyright</strong> <i class="far fa-copyright"></i> 2020 -  Designed by Quensly B</p>
          </div>
          </div>
